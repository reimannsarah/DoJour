...
import { Entry, deleteEntry, getEntriesByUserId } from "../../service/apiService";
  ...
  return (
    <div className="relative flex flex-col mt-10">
      ...
      <div className="flex flex-row justify-evenly">
        ...
        >
          <XCircleIcon className="absolute w-5 h-5 right-0 top-0 text-darkTertiary m-3 cursor-pointer" onClick={() => setModalIsOpen(false)}/>
          <div className="flex flex-row justify-between">
            <h1 className="font-header text-5xl text-darkTertiary">{currentEntry?.title}</h1>
